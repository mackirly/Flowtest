...
from ..models import Role, Permission, CustomUser # Adjusted import path for models
from ..serializers import ( # Adjusted import path for serializers
    UserSerializer, 
...
from ..permissions import ( # Adjusted import path for permissions
    IsAdminUser, 
